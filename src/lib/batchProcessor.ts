...
import Customer, { CustomerCollection } from '@/models/Customer';
...
// Use globalThis to maintain a single instance across imports
if (!global.batchProcessorInstance) {
  global.batchProcessorInstance = BatchProcessor.getInstance();
}

batchProcessor = global.batchProcessorInstance;
